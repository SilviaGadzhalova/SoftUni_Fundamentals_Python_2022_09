numbers = input().split(", ")
positive_nums = [number for number in numbers if int(number) >= 0]
negative_nums = [number for number in numbers if int(number) < 0]
even_nums = [number for number in numbers if int(number) % 2 == 0]
odd_nums = [number for number in numbers if int(number) % 2 != 0]
